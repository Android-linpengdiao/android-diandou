...
public class Mp3Utils {
     ...
     * @throws IOException
     */
    public static String heBingMp3(List<String> path_list, String name) throws IOException {
        String luJing = Environment.getExternalStorageDirectory().getPath()+"/sxyy/";
        ...
        for (int i = 0; i < path_list.size(); i++) {
            String fenLiData = fenLiData(path_list.get(i));
